...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='coffee',
            name='create_at',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2021, 12, 6, 3, 31, 52, 228421, tzinfo=utc)),
        ...
        migrations.AddField(
            model_name='grinding',
            name='create_at',
            field=models.DateTimeField(auto_now_add=True, default=datetime.datetime(2021, 12, 6, 3, 34, 35, 284497, tzinfo=utc)),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='grinding',
